...
@Composable
fun LoginPage(viewModel: LoginViewModel, doOnRegisterClick: () -> Unit, doOnLoginClick: () -> Unit = {}) {
    ...
    Column(
        ...
        ButtonPrimary(stringResource(id = R.string.masuk), modifier = Modifier.buttonModifier()) {
